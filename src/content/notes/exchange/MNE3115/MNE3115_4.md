...
In *dry* etchants, the etch reactants come from a gas or vapor phase source and are typically ionized (e.g., reactive ion etching, RIE).

#### Etching considerations
* Etch Rate
    - Rate of material removal [$\mu\mathrm{m/min}$]
...
### Dry Etching
To perform the dry etching process, we perform different steps. Let's take a look.
...
Similar to CVD (Chemical Vapor Deposition), the process includes reaction and transportation (i.e., diffusion).
...
* Isotropic
* High etching rate, 3-10 $\mu\mathrm{m/min}$ for Si at around 1 torr (1 atm = 760 torr).
...
Lower operation pressure, typically 10 - 200 mtorr (usually lower than 0.1 torr).
...
* Silicon Dioxide (SiO$_2$) Wet Etching
    ...
    - Etches SiO$_2$ but not Si, may also attack Al, Si$_3$N$_4$, $\ldots$
...
* Aluminum (Al) Wet Etching
    ...
    - Nitric acid forms aluminum oxide on surface and phosphoric acid and water dissolves the material.
    - Positive photoresist can be used as a mask.
* Titanium (Ti) Wet Etching
    - HF based solution or NH$_4$OH + H$_2$O$_2$ + H$_2$O.
* Gold (Au) Wet Etching
    - Etchant HCl : HNO$_3$ = 3 : 1 (will yield large undercut), KI or iodine in water (KI + I$_2$ + H$_2$O = 4 : 1 : 40, more practical, but opaque), or cyanide-based (toxic).
    - Photoresist can be used as a mask.
* Platinum and Palladium (Pt, Pd) Wet Etching
    - Pt: Etchant HCl : HNO$_3$ = 3 : 1 (aqua regia) above $25\,^\circ\mathrm{C}$.
    - Pd: HCl + HNO$_3$ + CH$_3$COOH = 1 : 10 : 10, or KI + I$_2$ + H$_2$O = 4 : 1 : 40.
...
Silicon etching depends heavily on the type of crystallization of silicon.

Etching of amorphous (No recognizable long-range order)/polycrystalline (completely ordered, in segments) silicon is isotropic.

It can be anisotropic or isotropic (using HNA as just mentioned) for **crystalline silicon (bulk)** (Entire solid is made up of atoms in an orderly array).

#### Anisotropic (Crystalline) Silicon Etching
A process of preferential directional etching of material using liquid source etchants (a crystal orientation dependent etching).

The **number** of molecules per area is different in different facets.
...
Identical materials with ultra smooth (<1 nm roughness) are bonded without any intermediate layer.

Method:

:::algorithm[Fusion/direct bonding]{#alg:fusion-bonding}
1. Surface preparation: O$_2$ plasma, HF dip, hydration.
2. Wafers brought into contact to form weak bonds (van der Waals forces, hydrogen bonding).
3. Annealing at $600$ - $1200\,^\circ\mathrm{C}$ to convert physical forces to chemical bonds.
:::

#### Anodic Bonding
Anodic bonding is also referred to as electrostatic bonding or field-assisted thermal bonding.
...
* Elevated temperature $200$ - $500\,^\circ\mathrm{C}$.
...
* Diffusion of metal atoms between the surfaces, due to atomic contact between both substrates.

For aluminum (Al):
* Bonding temperature $400$ to $500\,^\circ\mathrm{C}$.
* Applied force above 70 MPa.

For Gold (Au):
* Bonding temperature $260$ to $450\,^\circ\mathrm{C}$.
* Applied force above 20 MPa.

For Copper (Cu):
* Bonding temperature $380$ to $450\,^\circ\mathrm{C}$.
