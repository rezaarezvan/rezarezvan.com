...
* 1940s: Development of radio technology and long-distance telephony
    - Created demand for signal amplification.
...
* Negative Resist:
    ...
    ![Overview of Photolithography Process.](./imgs/photolithography.svg "fig:photolithography")
...
* Inorganic Residue Removal
    ...
    - A variety of solutions can be used, sulfuric acid, sulfuric acid + hydrogen peroxide (Piranha cleaning).
...
The most common primer is **HMDS (Hexamethyldisilazane)**. $\mathrm{CH}_3$ group left outside which keeps hydrophobic resisting wet etching.
...
![Spin Coating Process.](./imgs/spin_coating.svg "fig:spin-coating")
...
* Streaks
    - Radial patterns caused by hard particles whose diameters are greater than the resist thickness.
...
Standing waves in resists can cause non-uniformity in the resist thickness.
