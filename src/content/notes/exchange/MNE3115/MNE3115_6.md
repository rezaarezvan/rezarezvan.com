...
$$
\sigma = \frac{F}{A} \quad [\mathrm{N/m^2}].
$$

We also usually use the unit Pa (Pascal) for stress, which is equivalent to $1\,\mathrm{N/m^2}$.
...
$$
\epsilon = \frac{x}{L} \quad [\mathrm{m/m}].
$$
...
$$
\frac{F}{x} = \text{stiffness} \quad [\mathrm{kN/m}].
$$
...
A graph of stress against strain will be a **straight line** with **gradient of $E$**.
...
This is the spring stiffness of the block in $\mathrm{N/m}$.
...
If a solid body is subjected to an axial tension, it contracts laterally.
