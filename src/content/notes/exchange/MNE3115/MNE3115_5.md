...
Thick ($5\,\mu\mathrm{m}$) **negative PR** is usually used.
...
depositing a thin film (such as a metal or dielectric) over the entire area,
...
With PMGI, the resist serves as a mask for DUV (250 nm) exposure and development of the PMGI.

The Shipley LOL and the LOR resists use bake temperature to control undercut rate using standard resist developers.
The top layer can be positive or negative tone and, you can lift-off up to ~2/3 of the bottom layer thickness.
...
On the silicon substrate is formed a silicon dioxide layer, whose thickness will determine the gap size for the cantilevered member.
...
5. Dry etch SiO$_2$ using RIE with CF$_4$ gas.
6. Remove PR using acetone.
7. PECVD Poly-Si.
8. Spincoat PR.
9. Pattern PR by photolithography.
10. Etch Poly-Si using RIE with SF$_6$ gas.
11. Remove PR using acetone.
12. Remove SiO$_2$ thoroughly by 4.9%
:::

### Nanoimprint Lithography (NIL)
Is a new technology that makes very small features for integrated circuits.

Better than photolithography because it can achieve smaller features.
Better than electron beam lithography because it takes less time to produce.

The method to do nanoimprint lithography is practical and fast.
Nanoimprint is one method of the future of lithography.

#### Nanoimprint Process
:::algorithm[Nanoimprint process]{#alg:nanoimprint}
1. Press in mold.
...
#### Pattern Transfer
:::algorithm[Pattern transfer]{#alg:pattern-transfer}
...
### Thermal VS. UV NIL
* Thermal NIL
    - **+**: Less restrictions on template
        - Si and Ni are okay.
    - **+**: Simpler/cleaner process.
        - UV resists are a little 'messy'.
    - **-**: More readily available poly/resists.
    - **-**: Temperature (but, controllable)
        - May be as high as $200\,^\circ\mathrm{C}$.
