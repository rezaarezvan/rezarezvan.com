...
The high temperature process is usually between $700$ to $1200\,^{\circ}\mathrm{C}$.
...
$$
J_R = kN_1 \quad [\mathrm{mol/(m^2 s)}].
$$
...
where $v$ ($= 27.3\,\mathrm{cm^3/mol}$) is the molar volume of the oxide.
...
For thin films,
$$
h \approx kN_0vt \quad \text{(reaction limit)}.
$$

For thick films,
$$
h \approx \sqrt{2DN_0vt} \quad \text{(diffusion limit)}.
$$
...
Poor thickness uniformity and conformity (step coverage). This also requires high temperatures.

#### Low-Pressure CVD (LPCVD)
LPCVD is a method to deposit thin films at low pressure.

This requires high temperature ($480$ to $1200\,^{\circ}\mathrm{C}$), and a pressure level typically $100$ to $300\,\mathrm{mTorr}$ (Long mean free path, high diffusivity and good step coverage).
...
This will lead to a faster reaction, also requires lower temperature, only in the $100$ to $400\,^{\circ}\mathrm{C}$ range.
...
Plasma is partially ionized gas mixture with equal number of positive (gas+) and negative ($e^-$) charges.
