...
**Transaction processing data models and systems** are engineered to accommodate **updates to a few records at a time**.
...
* Program Manager
    - Plans and oversees any pilot development to make sure that it remains aligned with organizational expectations, remains within an allocated budget, and is properly documented to ensure that the best practices can be captured and migrated into production.
