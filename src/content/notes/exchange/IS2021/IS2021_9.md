...
![Database Management Systems.](./imgs/dbms.svg "fig:dbms")
...
It is designed for distributed data stores where very large scale of data storing needs (for example Google or Facebook which collects terabytes of data every day for their users).
...
Examples are MongoDB, DynamoDB, CosmosDB.
