...
---
### Business Drivers
While many companies still are in the *first wave* of data management, there are some *business drivers* which drive a company to the *third wave*, or big data management.
...
Because of the above issues, the initial task should evaluate the organization’s fitness as a combination of the five factors mentioned, i.e. feasibility, reasonability, value, integrability, and sustainability.
...
![Radar Chart.](./imgs/radar_chart.svg "fig:radar-chart")

### Adoption Criteria of Big Data Applications
Use Big Data Analytics for problem-solving when there is or are such phenomena:
* Data throttling
