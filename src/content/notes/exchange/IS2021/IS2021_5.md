...
* Review
    - Summarizing what has been done and what has been missed.
...
`Key` can be composed of more than one data item, in this case, the key is called a **composite key** represented by `+`, e.g. "Product code + Vendor code".
...
The open-source platform incorporates a software architecture implemented on commodity computing clusters for resilience and scalability.
