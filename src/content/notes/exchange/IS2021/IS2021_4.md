...
MapReduce execution environment employs a master/slave execution model, in which one master node (**JobTracker**) manages a pool of slave computing resources (**TaskTrackers**) that are called upon to do the actual work.
