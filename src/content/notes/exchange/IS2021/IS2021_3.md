...
#### Software Appliances
We will go into more detail later on, but for now,
...
The advantage of computer clusters over single computers is that they usually improve the overall performance (and availability) greatly, while still being cheaper than individual high-performance computers.
