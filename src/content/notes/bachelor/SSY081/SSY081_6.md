...
We can rewrite using $\operatorname{sinc}(x) = \dfrac{\sin(x)}{x}$:
$$
F(\omega) = \tau \operatorname{sinc}\left(\dfrac{\omega \tau}{2}\right).
$$
...
We can do:
$$
F(t) = \tau \operatorname{sinc}\left(\dfrac{t \tau}{2}\right).
$$
...
Now this means:
$$
F(t) \iff 2\pi f(-\omega) = 2\pi \operatorname{rect}\left(\dfrac{-\omega}{\tau}\right).
$$
