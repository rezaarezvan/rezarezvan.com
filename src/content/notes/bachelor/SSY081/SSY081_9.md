...
#### Linearity
$$
f_1(t) \iff F_1(s), \quad f_2(t) \iff F_2(s),
$$
...
\begin{align*}
f(t) & \iff F(s), \newline
f(t - t_0) & \iff F(s)e^{-st_0}, \quad t_0 \geq 0, \newline
f(t)u(t) & \iff F(s), \newline
f(t - t_0)u(t - t_0) & \iff F(s)e^{-st_0}, \quad t_0 \geq 0.
\end{align*}
$$

#### Frequency shifting
$$
f(t) \iff F(s), \quad f(t)e^{s_0 t} \iff F(s - s_0).
$$

#### Time-differentiation
$$
f(t) \iff F(s), \quad \dfrac{df}{dt} \iff sF(s) - f(0^-).
$$
...
#### Scaling
$$
f(t) \iff F(s), \quad f(at) \iff \dfrac{1}{a} F\left(\dfrac{s}{a}\right), \quad a > 0.
$$
...
$$
f_1(t) f_2(t) \iff \dfrac{1}{2\pi j} \left[F_1(s) * F_2(s)\right].
$$
