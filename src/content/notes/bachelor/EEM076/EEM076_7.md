...
We have lightly touched on this before but - different types of materials will behave differently in electrical fields.

We can roughly say we have three categories of types - conductors, semiconductors and insulators.

:::definition[Conductors, insulators and semiconductors]
A conductor is, as the name suggests, where the electrons are weakly bound to the atoms.
...
![Conductors in electrical fields.](./imgs/conductor_fields.svg "fig:conductor-fields")
...
![Polar and non-polar dielectrics without and with an external field.](./imgs/dielectric_polarization.svg "fig:dielectric-polarization")
...
![The polarization field opposes the external field.](./imgs/dielectric_opposing_field.svg "fig:dielectric-opposing-field")
...
One very important detail we have yet to cover in electrical circuits is - what causes the current to move?

Imagine if we put a conductor inside an external electrical field - the charge will move due to the electrical field and create a current.
...
$$
\mathbf{\vec{F}}_B = q\mathbf{\vec{v}} \times \mathbf{\vec{B}}, \quad F_B = |q|vB \sin(\theta).
$$

The unit for magnetic field strength is Tesla,

$$
1 \ \mathrm{T} = 1 \ \mathrm{\dfrac{N}{A \cdot m}}.
$$

### Biot-Savart's law

:::theorem[Biot-Savart's law]
Given current through a wire, the magnetic field *from a single point on the wire is*,

$$
d\mathbf{\vec{B}} = \dfrac{\mu_0}{4\pi} \dfrac{I \, d\mathbf{\vec{s}} \times \hat{\mathbf{r}}}{r^2},
$$

where $\mu_0$ is the *permeability of free space*,

$$
\mu_0 = 4\pi \cdot 10^{-7} \ \mathrm{\dfrac{T \cdot m}{A}}.
$$
:::

We can also calculate the total magnetic field at a point, $P$, as the sum across all points along the current source,
