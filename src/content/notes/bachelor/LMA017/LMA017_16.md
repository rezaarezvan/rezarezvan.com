...
![The vector field $\vec{F}(x, y) = \langle -y, x \rangle$.](./imgs/rotation_field.svg "fig:rotation-field")
:::
...
& = \langle 2 + t(3 - 2), 0 + t(4 - 0), 0 + t(5 - 0) \rangle \newline
& = \langle 2 + t, 4t, 5t \rangle, \quad 0 \leq t \leq 1.
\end{align*}
$$

Which means:
$$
\vec{r^\prime}(t) = \langle 1, 4, 5 \rangle, \quad 0 \leq t \leq 1.
$$
