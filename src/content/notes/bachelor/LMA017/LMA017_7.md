...
:::example
A rectangular box is to be made from $12\,\mathrm{m}^2$ of cardboard. Find the maximum volume of such a box.
...
y^2 - x^2 & = 0, \newline
y^2 & = x^2, \newline
y & = x \quad \| \quad \text{since they are only positive}.
\end{align*}
$$
...
Since we cannot get an arbitrarily big volume out of $12\,\mathrm{m}^2$ of cardboard. Since there exists a critical point, this must be the absolute maximum.
$$
V_{\max} = V(2, 2) = \ldots = 4.
$$
:::
...
A boundary point at a set $D \subset \mathbb{R}^2$, is a point such that, any disc centered at this point contains both some points from $D$ and some points outside $D$.
:::
...
:::example
$$
\{(x, y) \in \mathbb{R}^2 \mid x^2 + y^2 \leq 1 \} \quad \| \quad \text{contains boundary points, closed set},
$$

$$
\{(x, y) \in \mathbb{R}^2 \mid x^2 + y^2 < 1 \} \quad \| \quad \text{does not contain boundary points, not closed set},
$$

$$
\{(x, y) \in \mathbb{R}^2 \mid x^2 + y^2 \leq 1, (x, y) \neq (0, 1) \} \quad \| \quad \text{does not contain boundary point, not closed set},
$$

$$
\{(x, y) \in \mathbb{R}^2 \mid y \geq 0 \} \quad \| \quad \text{contains boundary points, closed set}.
$$
:::
...
$$
\begin{align*}
L_1 & = \{(x, y) \mid 0 \leq x \leq 3, y = 0 \}, \newline
L_2 & = \{(x, y) \mid x = 3, 0 \leq y \leq 2 \}, \newline
L_3 & = \{(x, y) \mid 0 \leq x \leq 3, y = 2 \}, \newline
L_4 & = \{(x, y) \mid x = 0, 0 \leq y \leq 2 \}.
\end{align*}
$$
...
\begin{align*}
g(x) & = f(x, 0) = x^2, \newline
g(0) & = 0 & & \| \quad \text{abs. min.}, \newline
g(3) & = 9 & & \| \quad \text{abs. max.}
\end{align*}
$$
...
\begin{align*}
g(y) & = f(3, y) = 9 - 4y, \newline
g(2) & = 1 & & \| \quad \text{abs. min.}, \newline
g(0) & = 9 & & \| \quad \text{abs. max.}
\end{align*}
$$
...
\begin{align*}
g(x) & = f(x, 2) = x^2 - 4x + 4, \newline
g(2) & = 0 & & \| \quad \text{abs. min.}, \newline
g(0) & = 4 & & \| \quad \text{abs. max.}
\end{align*}
$$
