...
$$
\begin{align*}
\lim_{\Delta t \to 0} \Delta y & = \lim_{\Delta t \to 0} h(t + \Delta t) - h(t) \newline
& = \lim_{\Delta t \to 0} h(t) - h(t) \newline
& = 0.
\end{align*}
$$
...
& = (2yx + 3y^4) \cdot 2\cos(2t) + (x^2 + 12xy^3) \cdot (-\sin(t)).
\end{align*}
$$
...
$$
\begin{align*}
\dfrac{dz}{dt} \bigg\rvert_{t = 0} & = (2 \cdot 1 \cdot 0 + 3 \cdot 1^4) \cdot 2\cos(2 \cdot 0) + (0^2 + 12 \cdot 0 \cdot 1^3) \cdot (-\sin(0)) \newline
& = \ldots = \boxed{6}.
\end{align*}
$$
:::
...
& = \ldots = 4yx^3 \cdot re^t + (x^4 + 2z^3y) \cdot 2rse^{-t} + 3y^2z^2 \cdot r^2 \sin(t).
\end{align*}
$$
...
$$
\dfrac{\partial u}{\partial s} \bigg\rvert_{r = 1, s = 1, t = 0} = \ldots = \boxed{6}.
$$
:::
