...
:::example
$$
f(x, y) = x \quad \| \quad \text{is continuous at } \mathbb{R}^2.
$$
...
$$
f(x, y) = x^3y - y^2 + x \quad \| \quad \text{is continuous at } \mathbb{R}^2.
$$
...
$$
f(x, y) = \dfrac{x^3 y^3 - x^4y}{y - x} \quad \| \quad \text{is continuous \textbf{on its domain}}.
$$
...
$$
f(x, y) = e^{x^2 - y} \quad \| \quad \text{is continuous at } \mathbb{R}^2.
$$
...
$$
\lim_{(x, y) \to (1, 3)} e^{x^2 - y} = e^{1^2 - 3} = \boxed{e^{-2}}
$$
...
$$
\begin{align*}
\lim_{(x, y) \to (0, 0)} \dfrac{x^4 - y^4}{x^2 + y^2} & = \lim_{(x, y) \to (0, 0)} \dfrac{(x^2 + y^2)(x^2 - y^2)}{x^2 + y^2} \newline
...
\begin{align*}
f(x, y) & = \sin(x^2y - 3x), \newline
f_x(x, y) & = \cos(x^2y - 3x) \cdot (2xy - 3) & & \| \quad \text{chain rule}, \newline
f_y(x, y) & = \cos(x^2y - 3x) \cdot x^2 & & \| \quad \text{chain rule}.
\end{align*}
$$
