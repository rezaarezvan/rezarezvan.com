...
$$
\begin{align*}
-\int_{1}^{-1} 3u^2 \, du & = \int_{-1}^{1} 3u^2 \, du \newline
...
$$
\int_C 2x \, ds = \int_{C_{\text{parabola}}} 2x \, ds + \int_{C_{\text{line}}} 2x \, ds
$$
...
& = \langle 1 + t(1 - 1), 1 + t(2 - 1) \rangle \newline
& = \langle 1, 1 + t \rangle, \newline
\vec{r}^\prime(t) & = \langle 0, 1 \rangle, \quad 0 \leq t \leq 1.
\end{align*}
$$

$$
\begin{align*}
\int_{C_{\text{line}}} 2x \, ds & = \int_0^1 2 \cdot 1 \cdot \sqrt{0^2 + 1^2} \, dt \newline
...
\vec{r}^\prime(t) & = \langle 1, 2t \rangle, \quad 0 \leq t \leq 1.
\end{align*}
$$

$$
\int_{C_{\text{parabola}}} 2x \, ds = 2 \int_0^1 t \cdot \sqrt{1 + (2t)^2} \, dt
$$

Let $u = 1 + (2t)^2$, $du = 8t \, dt$, $u(0) = 1 + (2 \cdot 0)^2 = 1$ and $u(1) = 1 + (2\cdot 1)^2 = 5$

$$
\begin{align*}
\dfrac{2}{8} \int_1^5 \sqrt{u} \, du & = \dfrac{1}{4} \dfrac{u^{\frac{3}{2}}}{\dfrac{3}{2}} \bigg\rvert_{u = 1}^{u = 5} \newline
...
Therefore:
$$
\int_C 2x \, ds = \int_{C_{\text{parabola}}} 2x \, ds + \int_{C_{\text{line}}} 2x \, ds = \boxed{\dfrac{5^{\frac{3}{2}} - 1}{6} + 2}
$$
:::
...
$$
\vec{r}(t) = \langle \cos(t), \sin(t) \rangle, \quad 0 \leq t \leq \pi.
$$
...
Which means:
$$
\rho(x, y) = k(1 - y), \quad k \in \mathbb{R}.
$$

Find the center of mass.

$$
x_0 = 0 \quad \text{due to symmetry}
$$
...
& = \dfrac{\dfrac{4 - \pi}{2}}{(\pi - 2)} \newline
& = \dfrac{4 - \pi}{2} \dfrac{1}{(\pi - 2)} \newline
& = \dfrac{4 - \pi}{2\pi - 4}.
\end{align*}
$$
:::
...
\begin{align*}
\vec{r}(t) & = \langle x_0 + ta, y_0 + tb \rangle \newline
& = \langle -5 + t(0 - (-5)), -3 + t(2 - (-3)) \rangle \newline
& = \langle -5 + 5t, -3 + 5t \rangle, \quad 0 \leq t \leq 1, \newline
\vec{r}^\prime(t) & = \langle 5, 5 \rangle, \quad 0 \leq t \leq 1.
\end{align*}
$$
