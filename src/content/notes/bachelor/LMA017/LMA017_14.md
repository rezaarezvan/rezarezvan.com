...
### Introduction
In this part we'll cover curves and how we can parameterize a curve.
...
$$
\vec{r}(t) = \langle t, t \rangle \quad \| \quad 0 \leq t \leq 1
$$

But we could also say that:
$$
\vec{r}(t) = \langle t^2, t^2 \rangle \quad \| \quad 0 \leq t \leq 1
$$
...
$$
\vec{r}(t) = \langle 1 - t, 1 - t \rangle \quad \| \quad 0 \leq t \leq 1
$$

Let's try for a more complex function. Given the unit circle, $x^2 + y^2 = 1$.
$$
\vec{r}(t) = \langle \cos(t), \sin(t) \rangle \quad \| \quad 0 \leq t \leq 2\pi
$$

In general:
$$
\vec{r}(t) = \langle t, f(t) \rangle \quad \| \quad a \leq t \leq b
$$
:::
...
Then:
$$
\vec{r}'(t) = \langle f^\prime(t), g^\prime(t), h^\prime(t) \rangle
$$
...
$$
\vec{r}'(t) = \langle \dfrac{1}{2\sqrt{t}}, -1 \rangle
$$

$$
\vec{r}'(1) = \langle \dfrac{1}{2}, -1 \rangle
$$

$$
|\vec{r}'(1)| = \ldots = \dfrac{\sqrt{5}}{2}
$$

$$
\vec{T}(1) = \dfrac{\vec{r}'(1)}{|\vec{r}'(1)|}
$$
...
:::example
Find the parameterization equation to the tangent line to the helix, $x = 2\cos(t), y = \sin(t), z = t$. At point $(0, 1, \dfrac{\pi}{2})$.

From this we easily see that $t = \dfrac{\pi}{2}$.

The tangent line passes through $\vec{T}\left(\dfrac{\pi}{2}\right)$.
...
$$
\vec{r}'(t) = \langle -2 \sin(t), \cos(t), 1 \rangle
$$

$$
\vec{r}'\left(\dfrac{\pi}{2}\right) = \langle -2, 0, 1 \rangle
$$

$$
|\vec{r}'\left(\dfrac{\pi}{2}\right)| = \sqrt{(-2)^2 + 0^2 + 1^2} = \sqrt{5}
$$

$$
\vec{T}\left(\dfrac{\pi}{2}\right) = \langle - \dfrac{2}{\sqrt{5}}, 0, \dfrac{1}{\sqrt{5}} \rangle
$$

Now let's set this into our equation:
$$
x(t) = 0 + t \cdot \left(-\dfrac{2}{\sqrt{5}}\right) = \boxed{-\dfrac{2t}{\sqrt{5}}}
$$
