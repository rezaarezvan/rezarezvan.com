...
$$
f(a, b) \geq f(x, b) \quad \| \quad x \text{ near } a.
$$
...
$$
\begin{align*}
f''(a) & > 0 & & \| \quad \text{local min}, \newline
f''(a) & < 0 & & \| \quad \text{local max}, \newline
f''(a) & = 0 & & \| \quad \text{does not say anything}.
\end{align*}
$$
...
This means:
$$
D = -4 \quad \| \quad \text{saddle point}.
$$
:::
...
\begin{align*}
\nabla f & = 0, \newline
\langle 4x^3 - 4y, 4y^3 - 4x \rangle & = 0.
\end{align*}
$$
...
$$
\begin{cases}
D(0, 0) = -16 & \| \quad \text{saddle point}, \newline
D(1, 1) = 128 & \| \quad \text{local minimum}, \newline
D(-1, -1) = 128 & \| \quad \text{local minimum}.
\end{cases}
$$
:::
