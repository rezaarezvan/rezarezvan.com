...
$$
D_{\vec{i}} f(x_0, y_0) = \lim_{h \to 0} \dfrac{f(x_0 + h, y_0) - f(x_0, y_0)}{h} = f_x,
$$

$$
D_{\vec{j}} f(x_0, y_0) = \lim_{h \to 0} \dfrac{f(x_0, y_0 + h) - f(x_0, y_0)}{h} = f_y.
$$
:::
...
$$
\text{a)} \quad \vec{v} = \langle \dfrac{1}{\sqrt{2}}, \dfrac{1}{\sqrt{2}} \rangle,
$$

$$
\text{b)} \quad \vec{v} = 2\vec{i} + 5\vec{j}.
$$

Solution:
$$
\text{a)} \quad D_{\vec{v}} f = \nabla f \cdot \vec{v}.
$$
...
$$
|\vec{v}| = \sqrt{\left( \dfrac{1}{\sqrt{2}}\right)^2 + \left(\dfrac{1}{\sqrt{2}}\right)^2} = 1 \quad \| \quad \text{unit vector}.
$$
...
& = \langle e^0, 2e^0 \rangle = \langle 1, 2 \rangle.
\end{align*}
$$
