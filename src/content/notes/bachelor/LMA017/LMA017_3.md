...
$$
\begin{align*}
f_{xx} & = \lim_{h \to 0} \dfrac{f_x(x + h, y) - f_x(x, y)}{h}, \newline
f_{xy} & = \lim_{h \to 0} \dfrac{f_x(x, y + h) - f_x(x, y)}{h}, \newline
f_{yx} & = \lim_{h \to 0} \dfrac{f_y(x + h, y) - f_y(x, y)}{h}, \newline
f_{yy} & = \lim_{h \to 0} \dfrac{f_y(x, y + h) - f_y(x, y)}{h}.
\end{align*}
$$
...
$$
f_x = \dfrac{\partial f}{\partial x}, \quad f_y = \dfrac{\partial f}{\partial y}.
$$
...
f_{xy} & = \dfrac{\partial \left(\dfrac{\partial f}{\partial x} \right)}{\partial y} = \dfrac{\partial^2 f}{\partial y \partial x}, \newline
f_{yx} & = \dfrac{\partial \left(\dfrac{\partial f}{\partial y} \right)}{\partial x} = \dfrac{\partial^2 f}{\partial x \partial y}, \newline
...
### Geometrical sense
Let's try to understand what derivatives in two variables looks like geometrically.
...
Where:
$$
\varepsilon_1 = \varepsilon_1(\Delta x, \Delta y), \quad \varepsilon_2 = \varepsilon_2(\Delta x, \Delta y).
$$
