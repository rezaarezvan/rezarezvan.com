...
HTML forms a **tree** of nested elements, marked with **tags**.
```html
<p class="foo">
    bar
</p>
...
#### BeautifulSoup
BeautifulSoup is a Python library that parses HTML (and XML) documents, and creates an abstract tree from the elements.
