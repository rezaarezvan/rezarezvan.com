...
---
As we discussed in the first part of this series, there are two main paradigms.
...
**Field-Programmable Gate Arrays**, or FPGAs are one example of reconfigurable hardware.
...
A logic cluster consists of N LCs. The LCs in each cluster are fully or nearly fully connected with each other.

### LUT size
The size of our LUT and how we implement them have their pros and cons:
