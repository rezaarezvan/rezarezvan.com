...
Meaning that:
$$
S(s) + T(s) = 1 \quad \text{(Not hard to see)}.
$$
...
$$
Y(s) = \dfrac{5}{1 + 5s} F_d(s), \quad F_d(s) = \dfrac{0.1}{1 + s}U(s), \quad U(s) = \dfrac{(1 + s)F_d(s)}{0.1}.
$$
...
$$
\omega_n = \sqrt{0.1K_p}, \quad \zeta = \dfrac{1}{2 \omega_n} = \dfrac{1}{2 \sqrt{0.1K_p}}.
$$
:::
