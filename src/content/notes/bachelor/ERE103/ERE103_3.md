...
The poles are given by the equation $A(s) = 0$.
:::
...
& = E(s) \left(K_p\left(1 + \dfrac{K_i}{K_p} \cdot \dfrac{1}{s}\right)\right) \newline
...
$$
G_{uy}(s) = \dfrac{Y(s)}{U(s)} = \dfrac{K_u}{(ms + b)(1 + T_u s)}.
$$

Given some values:
* $m = 10^3\,\mathrm{kg}$
* $b = 200\,\mathrm{Ns/m}$
* $K_u = 10\,\mathrm{kN/rad}$
* $T_u = 1\,\mathrm{s}$

$$
G_{uy}(s) = \dfrac{10^4}{(10^3s + 200)(1 + s)} = \ldots = \boxed{\dfrac{50}{(1 + 5s)(1 + s)}}.
$$
:::
...
& = \dfrac{50K_p}{(1 + 5s)(1 + s) + 50K_p} \newline
& = \dfrac{10K_p}{s^2 + \dfrac{6}{5}s + \dfrac{1}{5} + 10K_p}.
\end{align*}
$$
...
& = \lim_{s \to 0} s \cdot G_{ry}(s) \cdot R(s) \newline
& = \lim_{s \to 0} s \cdot \dfrac{10K_p}{s^2 + \dfrac{6}{5}s + \dfrac{1}{5} + 10K_p} \cdot \dfrac{r_0}{s} \newline
& = \dfrac{10K_p}{\dfrac{1}{5} + 10K_p} \cdot r_0.
\end{align*}
$$

Thus
$$
\lim_{t \to \infty} y(t) = \dfrac{10K_p}{\dfrac{1}{5} + 10K_p} \cdot r_0 < r_0.
$$
...
$$
\omega_n = \sqrt{0.2 + 10 K_p}, \quad K = \dfrac{10K_p}{0.2 + 10 K_p}, \quad \zeta = \dfrac{1.2}{2 \sqrt{0.2 + 10 K_p}}.
$$
...
We know:
$$
F(s) = K_p \left(\dfrac{1 + T_i s}{T_i s} \right), \quad G(s) = \dfrac{50}{(1 + 5s)(1 + s)}.
$$

From $G(s)$ we can see that we have two poles. One pole is "fast", $T = 1\,\mathrm{s}$ $(1 + s)$. The other "slow", $T = 5\,\mathrm{s}$ $(1 + 5s)$.

If we choose $T_i = 5\,\mathrm{s}$, then:
$$
...
\begin{align*}
G_{ry}(s) & = \dfrac{L(s)}{1 + L(s)} \newline
& = \dfrac{\dfrac{50 K_p}{(5s)(1 + s)}}{1 + \dfrac{50 K_p}{(5s)(1 + s)}} \newline
& = \dfrac{50 K_p}{(5s)(1 + s) + 50 K_p} \newline
& = \dfrac{10 K_p}{s^2 + s + 10 K_p}.
\end{align*}
$$
...
& = \lim_{s \to 0} s \cdot G_{ry}(s) R(s) \newline
& = \lim_{s \to 0} s \cdot \dfrac{10 K_p}{s^2 + s + 10 K_p} \cdot \dfrac{r_0}{s} \newline
& = \lim_{s \to 0} \dfrac{10 K_p}{s^2 + s + 10 K_p} \cdot r_0 \newline
& = \dfrac{10 K_p}{10 K_p} \cdot r_0 \newline
& = \boxed{r_0}.
\end{align*}
$$
