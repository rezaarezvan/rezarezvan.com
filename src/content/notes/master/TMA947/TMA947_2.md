...
$$
\lambda \mathbf{x}_1 + (1 - \lambda) \mathbf{x}_2 \in S_k, \quad \forall k = 1, \ldots, K
$$
...
$$
\mathbf{a}_i^T \mathbf{x} \leq b_i, \quad \forall i = 1, \ldots, n
$$
...
$$
\lambda \mathbf{x} \in C, \quad \forall \mathbf{x} \in C, \quad \lambda > 0
$$
:::
...
\begin{align*}
Q & = P + C \newline
& = \{\mathbf{x} \in \mathbb{R}^m \mid \mathbf{x} = \mathbf{u} + \mathbf{v}, \quad \mathbf{u} \in P, \quad \mathbf{v} \in C \}
\end{align*}
$$
:::
