...
Suppose $S \subseteq \mathbb{R}^n$ is a convex set. Let $f: S \to \mathbb{R}$ be a function.
...
Let $S \subseteq \mathbb{R}^n$ be a convex set and $f_k: S \to \mathbb{R}, k=1, \ldots, K$ be convex functions.
...
Let $g: \mathbb{R}^n \to \mathbb{R}$ be a convex function and $f: \mathbb{R} \to \mathbb{R}$ [^note-1] be a convex function and non-decreasing [^note-2] function. Then, the composition $f(g(\mathbf{x}))$ is convex.
:::

:::example[Composition of Convex Functions]
Let f$(x) = e^x$ and $g(x) = x^2$. Both are convex on $\mathbb{R}$ and $f$ is non-decreasing.
By our proposition, $f(g(x)) = e^{x^2}$ is convex (on $\mathbb{R}$) [^note-3].
:::

## The Epigraph of a Function
:::definition[Epigraph of a Function]
The epigraph of a function $f: \mathbb{R}^n \to \mathbb{R} \cup \{\pm \infty \}$ is defined as,
$$
...
Let $S \subseteq \mathbb{R}^n$ be a convex set and $f: S \to \mathbb{R}$ be a convex function.
...
Let $S \subseteq \mathbb{R}^n$ be a convex set and $f: S \to \mathbb{R}$ be a convex function. The subdifferential of $f$ at $\mathbf{x^{\prime}} \in S$ is defined as,
$$
...
Let $S \subseteq \mathbb{R}^n$ be a convex set and $f: S \to \mathbb{R}$ be a convex function. If $\mathbf{x}^{\prime} \in \mathrm{int} \, S$ [^note-4], and $f$ is differentiable at $\mathbf{x}^{\prime}$, then,
$$
...
[^note-1]: Note that one can generalize this statement, the domains do not necessarily need to be $\mathbb{R}^n$ and $\mathbb{R}$, respectievly.
[^note-2]: The motivation here is, if we have $f(x) = -x$, our composition will become concave.
[^note-3]: Note that if we restrict our domain to $\mathbb{R}^{+}$, $g(x) = x^2$ becomes non-decreasing and thus $g(f(x)) = (e^x)^2 = e^{2x}$ is convex on $\mathbb{R}^{+}$ as well.
[^note-4]: $\mathrm{int} \, S$ is the interior of $S$.
