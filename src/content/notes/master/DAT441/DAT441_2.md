...
$$
\begin{align*}
\boldsymbol{\mu} &= \{0.8, 0.75, 0.3\} \newline
\boldsymbol{\mu} &= \{0.8, 0.1, 0.05\}
\end{align*}
$$
...
We have that $n_t(\cdot) \approx \frac{t}{2}$. Thus [^note-1],
...
[^note-1]: This is by the Hoeffding Inequality under the clean event
