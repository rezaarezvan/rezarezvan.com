...
$$
P(S_t = s, R_t = r \mid S_{t-1}, A_{t-1}, R_{t-1}, \ldots, R_1, S_0, A_0) = P(S_t = s, R_t = r \mid S_{t-1}, A_{t-1})
$$
...
- $\mathcal{p}(s^{\prime}, r \mid s, a)$ is the joint probability of next state $s^{\prime} \in \mathcal{S}$ and reward $r \in \mathcal{R}$, given the current state $s \in \mathcal{S}$ and action $a \in \mathcal{A}$.
...
$$
\mathcal{p}(s^{\prime}, r \mid s, a) = P(S_t = s^{\prime}, R_t = r \mid S_{t-1} = s, A_{t-1} = a)
$$

::::note
$$
\sum_{s^{\prime} \in \mathcal{S}} \sum_{r \in \mathcal{R}} \mathcal{p}(s^{\prime}, r \mid s, a) = 1, \quad \forall s \in \mathcal{S}, a \in \mathcal{A}
$$
Why?
:::solution
...
$$
\mathcal{p}(s^{\prime} \mid s, a) = P(S_t = s^{\prime} \mid S_{t-1} = s, A_{t-1} = a) = \sum_{r \in \mathcal{R}} \mathcal{p}(s^{\prime}, r \mid s, a)
$$
- The expected rewards for state-action pairs,
$$
r(s, a) = \mathbb{E}[R_t \mid S_{t-1} = s, A_{t-1} = a] = \sum_{r \in \mathcal{R}} r \sum_{s^{\prime} \in \mathcal{S}} \mathcal{p}(s^{\prime}, r \mid s, a)
$$
- The expected rewards for state-action-next-state triples,
$$
r(s, a, s^{\prime}) = \mathbb{E}[R_t \mid S_{t-1} = s, A_{t-1} = a, S_t = s^{\prime}] = \frac{\sum_{r \in \mathcal{R}} r \mathcal{p}(s^{\prime}, r \mid s, a)}{\mathcal{p}(s^{\prime} \mid s, a)}
$$
...
Thus, $\pi(a \mid s)$ is the probability that action $a$ is taken when in state $s$.
$$
...
$$
\begin{align*}
v_{\pi}(s) & \coloneqq \mathbb{E}_{\pi, \mathcal{p}}[G_t \mid S_t = s] \newline
& = \mathbb{E}_{\pi, \mathcal{p}}\left[\sum_{k=0}^{\infty} \gamma^k R_{t+k+1} \middle| S_t = s\right], \quad \forall s \in \mathcal{S}
\newline
q_{\pi}(s, a) & \coloneqq \mathbb{E}_{\pi, \mathcal{p}}[G_t \mid S_t = s, A_t = a] \newline
& = \mathbb{E}_{\pi, \mathcal{p}}\left[\sum_{k=0}^{\infty} \gamma^k R_{t+k+1} \middle| S_t = s, A_t = a\right], \quad \forall s \in \mathcal{S}, a \in \mathcal{A}(s)
\end{align*}
$$
:::
...
$$
v_{\pi}(s) = \sum_{a} \pi(a \mid s) \sum_{s^{\prime}, r} \mathcal{p}(s^{\prime}, r \mid s, a) [r + \gamma v_{\pi}(s^{\prime})], \quad \forall s \in \mathcal{S}
$$
...
$$
\begin{align*}
v_{\pi}(s) & = \mathbb{E}_{\pi, \mathcal{p}}[G_t \mid S_t = s] \newline
& = \mathbb{E}_{\pi, \mathcal{p}}[R_{t+1} + \gamma G_{t+1} \mid S_t = s] \newline
& = \sum_a \pi(a \mid s) \sum_{s^{\prime}, r} \mathcal{p}(s^{\prime}, r \mid s, a) [r + \gamma \mathbb{E}_{\pi}[G_{t+1} \mid S_{t+1} = s^{\prime}]] \newline
& = \sum_a \pi(a \mid s) \sum_{s^{\prime}, r} \mathcal{p}(s^{\prime}, r \mid s, a) [r + \gamma v_{\pi}(s^{\prime})], \quad \forall s \in \mathcal{S} \newline
\end{align*}
$$
:::
...
$$
v_{\star}(s) \coloneqq \max_{\pi} v_{\pi}(s), \quad \forall s \in \mathcal{S}
$$
:::
...
$$
\begin{align*}
q_{\star}(s, a) \coloneqq \max_{\pi} q_{\pi}(s, a), \quad \forall s \in \mathcal{S}, a \in \mathcal{A}(s)
& = \mathbb{E}[R_{t+1} + \gamma v_{\star}(S_{t+1}) \mid S_t = s, A_t = a] \newline
\end{align*}
$$
...
$$
v_{\star}(s) = \max_a \sum_{s^{\prime}, r} \mathcal{p}(s^{\prime}, r \mid s, a) [r + \gamma v_{\star}(s^{\prime})], \quad \forall s \in \mathcal{S}
$$
...
& = \max_{a} \mathbb{E}_{\pi_{\star}, \mathcal{p}}[G_t \mid S_t = s, A_t = a] \newline
& = \max_{a} \mathbb{E}_{\pi_{\star}, \mathcal{p}}[R_{t+1} + \gamma G_{t+1} \mid S_t = s, A_t = a] \newline
& = \max_{a} \mathbb{E}_{\mathcal{p}}[R_{t+1} + \gamma v_{\star}(S_{t+1}) \mid S_t = s, A_t = a] \newline
& = \max_{a} \sum_{s^{\prime}, r} \mathcal{p}(s^{\prime}, r \mid s, a) [r + \gamma v_{\star}(s^{\prime})], \quad \forall s
\end{align*}
$$
:::
...
$$
q_{\star}(s, a) = \sum_{s^{\prime}, r} \mathcal{p}(s^{\prime}, r \mid s, a) [r + \gamma \max_{a^{\prime}} q_{\star}(s^{\prime}, a^{\prime})], \quad \forall s \in \mathcal{S}, a \in \mathcal{A}(s)
$$
where the sums are over all possible next states and rewards.
:::
...
$$
\begin{align*}
q_{\star}(s, a) & = \mathbb{E}_{\pi_{\star}, \mathcal{p}}[R_{t+1} + \gamma \max_{a^{\prime}} q_{\star}(S_{t+1}, a^{\prime}) \mid S_t = s, A_t = a] \newline
& = \sum_{s^{\prime}, r} \mathcal{p}(s^{\prime}, r \mid s, a) [r + \gamma \max_{a^{\prime}} q_{\star}(s^{\prime}, a^{\prime})], \quad \forall s \in \mathcal{S}, a \in \mathcal{A}(s) \newline
\end{align*}
$$
:::
