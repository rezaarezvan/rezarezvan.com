...
![An ideal test scenario. Our threshold captures the boundary perfectly.](./imgs/binary_test_ideal.svg "fig:t")

In @fig:t, we see that the test is perfect.
The threshold is set at the boundary between the two classes.

![A real-world test scenario. Our threshold captures the boundary imperfectly.](./imgs/binary_test_overlap.svg "fig:t2")
