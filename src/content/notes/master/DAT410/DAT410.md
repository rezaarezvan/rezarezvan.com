...
![A Turing machine.](./imgs/turing_machine.svg "fig:turing-machine")
...
![Algorithmic view of chess, a game tree with backed-up values.](./imgs/minimax_tree.svg "fig:minimax-tree")

AI was rapidly developed in the 1950s and 1960s.
It even had some early success, for example with games like chess, where the rules are clear and the number of possible moves is limited [^note-1].
...
[^note-1]: Although enumerating all possible chess games was computationally infeasible at the time (and still is).
